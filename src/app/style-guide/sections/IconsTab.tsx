        ...
        <Section id="Status & Utility" title="Status & Utility Icons" onVisible={onSectionVisible}>
          ...
          <div className="w-full grid grid-cols-6 gap-m">
            {([
              ...
              { name: 'Clock (Inactive)', svg: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>, sizes: '10, 16', usage: 'DormantCharacterCard badge, DormancyBanner', color: 'text-white-40' },
              { name: 'Shield (Policy)', svg: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>, sizes: '10, 16', usage: 'DormantCharacterCard badge, DormancyBanner', color: 'text-status-warning' },
              { name: 'Block (Removed)', svg: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="12" cy="12" r="10"/><line x1="4.93" y1="4.93" x2="19.07" y2="19.07"/></svg>, sizes: '16', usage: 'DormancyBanner removed variant', color: 'text-status-alert' },
              { name: 'Warning Triangle', svg: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>, sizes: '16, 18', usage: 'Needs Attention section header, DormancyBanner moderation', color: 'text-status-warning' },
              { name: 'Info Circle', svg: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>, sizes: '16', usage: 'States info button, info banners', color: 'text-text-dim' },
          ...
          <div className="w-full">
            ...
            <div className="flex flex-col gap-s">
              {[
                ...
                { context: 'Warning / Moderation', token: 'text-status-warning', hex: '#ffc32a', desc: 'Warning triangle, shield icon, moderation badges' },
                { context: 'Muted / Dormant', token: 'text-white-40', hex: '#ffffff66', desc: 'Clock icon on dormant inactive badges and banners' },
              ].map(r => (

  ...
  return (
    <Section id="Chat Messages" title="Chat Messages" onVisible={onSectionVisible}>
      ...
      <div className="min-w-[440px] flex-1">
        ...
        <PreviewBox>
          <div className="flex flex-col gap-m w-full max-w-[400px]">
            {/* User bubble */}
            <div className="flex justify-end w-full">
              <div className="bg-chat-user-bubble px-s py-[10px] rounded-tl-2xl rounded-tr-2xl rounded-bl-2xl max-w-[360px]">
              ...
              <div className="flex flex-col max-w-[290px] min-w-[64px]">
                ...
                <div className="flex items-center pt-xxs">
                  <div className="flex items-center gap-xxs">
                    ...
                    <button className="p-xs rounded-full backdrop-blur-[32px] bg-black-70 border border-white-10 hover:bg-white-10 transition-colors"><div className="w-4 h-4 rounded-sm bg-white-10" /></button>
                    <button className="p-xs rounded-full backdrop-blur-[32px] bg-black-70 border border-white-10 hover:bg-white-10 transition-colors"><div className="w-4 h-4 rounded-sm bg-white-10" /></button>
                  </div>
                  <div className="flex-1" />
                  <div className="flex items-center gap-xxs">
                    {/* Generate image — warm gradient placeholder */}
                    <button className="p-xs rounded-full backdrop-blur-[32px] bg-black-70 border border-white-10 hover:bg-white-10 transition-colors shrink-0">
                      <div className="w-4 h-4 rounded-sm" style={{ background: 'var(--icon-gradient-warm)' }} />
                    </button>
                    <button className="p-xs rounded-full backdrop-blur-[32px] bg-black-70 border border-white-10 hover:bg-white-10 transition-colors">
      ...
      <div className="min-w-[440px] flex-1">
        ...
        <div className="flex flex-col gap-s text-xs text-text-body bg-white-05 border border-white-10 rounded-card p-m w-full">
          {[
            ['flex-1 overflow-y-auto flex flex-col gap-m', 'Scroll container'],
            ...
            ['p-xs rounded-full backdrop-blur-[32px] bg-black-70 border border-white-10', 'Action buttons — use bg-black-70 token'],
            ['p-xs rounded-full backdrop-blur-[32px] bg-black-70 border border-white-10 hover:bg-white-10 (GenerateImageBtn)', 'GenerateImage — same pattern as other action buttons; gradient-border wrapper removed'],

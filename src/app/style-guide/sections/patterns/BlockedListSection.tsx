      ...
      <div className="min-w-[440px] flex-1">
        ...
        <div className="flex flex-col gap-s text-xs text-text-body bg-white-05 border border-white-10 rounded-card p-m w-full">
          {[
            ...
            ['CTA flips in place: "Unblock" (filled) ↔ "Block" (outlined)', 'Both labels are verbs (next available action), not verb-then-status — "Blocked" would mislead the user into thinking the unblock failed'],
            ['Visual states: Filled bg-white-80 text-accent / Outlined bg-transparent border border-white-20 text-text-body', 'Filled = primary action that achieves user intent in this context. Outlined = de-emphasized reverse, available but not primary'],

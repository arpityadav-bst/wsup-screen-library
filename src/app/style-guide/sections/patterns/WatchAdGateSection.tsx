      ...
      <div className="min-w-[440px] flex-1">
        ...
        <div className="flex flex-col gap-s text-xs text-text-body bg-white-05 border border-white-10 rounded-card p-m w-full">
          {[
            ...
            ['Body — text-sm text-text-body, text-balance', 'Sheet: "Quick ad break before your next message. Same character, no progress lost." Bubble: "Watch a short ad to keep chatting — your message will send right after." Both address the same user fear (am I losing my draft / progress?) but bubble copy is shorter since the surface is more compact.'],

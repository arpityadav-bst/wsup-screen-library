      ...
      <div className="w-full max-w-[760px] flex flex-col gap-l">
        ...
        <div className="mt-s p-s bg-white-05 rounded-card border border-white-10 text-xs text-text-body leading-relaxed max-w-[600px]">
          ...
          <ul className="list-disc pl-l space-y-xxs">
            ...
            <li><strong>Body</strong> — app benefit, condensed: &ldquo;The app remembers 3× more of your story.&rdquo; Benefit-shaped (&quot;your story&quot; = your narrative is preserved), feature-quantified (&quot;3× more&quot;), one line.</li>
            <li><strong>Full-width primary CTA</strong> — Button size m fullWidth: &ldquo;Open in app.&rdquo;</li>
            <li><strong>Subtle divider</strong> — <code className="text-accent-light">border-t border-white-10</code>, edge-to-edge via <code className="text-accent-light">-mx-l</code>. Visually separates the primary install path from the alternate model-switch path.</li>
            <li><strong>Switch-model link</strong> — &ldquo;switch model instead&rdquo; using <code className="text-accent-light">.link</code> utility. Centered, no &quot;Or&quot; prefix — &quot;instead&quot; already does the contrast work. The fact that it&apos;s offered implies the model is the bottleneck; no need for an explicit model-context card above.</li>
          </ul>
          ...
          <p>MemoryLimitMoment is the lower-interrupt default — it lives in the chat scroll as part of Billie&apos;s next response (character voice, italic, in-stream). Use this popup variant when the moment needs more weight (e.g., install conversion matters more than chat continuity) — the popup is system narration that interrupts the flow rather than embedding into it.</p>

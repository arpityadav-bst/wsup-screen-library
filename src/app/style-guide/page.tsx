...
const NAV: Record<Tab, string[]> = {
  ...
  Components: ['Buttons', 'Forms', 'Auth Primitives', 'Tags & Cards', 'Coachmark', 'Character Card', 'Widgets', 'Category Tabs', 'Tabs', 'Filter Pills', 'Overlays', 'Lifecycle', 'Bottom Nav', 'Profile Cards', 'Profile Overlays', 'Reward Cards', 'UI Utilities'],
  Patterns:   ['Header', 'Sidebar', 'Explore Description', 'FAQ Accordion', 'What is wsup.ai', 'Footer', 'Mobile Footer', 'Chat Header', 'Chat Messages', 'Chat Bar', 'Chat Right Sidebar', 'Dormancy Banner', 'Low Credits Banner', 'Memory Limit Moment', 'Memory Limit Popup', 'Login Sheet', 'Streak Claim'],

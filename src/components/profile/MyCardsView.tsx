...
export default function MyCardsView({ open, onClose, cards }: MyCardsViewProps) {
  ...
  return (
    <>
      ...
      <div
        className="fixed inset-0 z-50 bg-page-bg flex flex-col md:hidden"
      ...
      <CenterPopup open={open} onClose={onClose} title="My Cards" subtitle={`${totalCards} total`} maxWidth="520px">
        <div className="p-l">
          <CardsGrid cards={cards} />
        </div>
      </CenterPopup>

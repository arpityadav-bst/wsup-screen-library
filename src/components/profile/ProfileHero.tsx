...
export default function ProfileHero({ name, avatar, creatorBadge, bio, onReadMore, onMenuOpen }: ProfileHeroProps) {
  return (
    <div className="flex flex-col items-center w-full relative">
      ...
      <div className="md:hidden absolute top-s right-s flex items-center gap-xxs">
        <button className="w-[36px] h-[36px] rounded-button flex items-center justify-center text-text-dim">
        ...
        <button onClick={onMenuOpen} className="w-[36px] h-[36px] rounded-button flex items-center justify-center text-text-dim">

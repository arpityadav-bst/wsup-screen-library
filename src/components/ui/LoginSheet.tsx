  ...
  return (
    <>
      ...
      <div className="fixed inset-0 hidden md:flex items-center justify-center" style={{ zIndex: 90 }}>
        ...
        />
        <div
          className="relative flex w-full max-w-[720px] h-[420px] rounded-popup overflow-hidden border border-white-20 shadow-popup"
          style={{ animation: 'slide-up 0.24s cubic-bezier(0.32,0.72,0,1)' }}
        >
          <div className="relative w-[40%] shrink-0 bg-footer-bg bg-surface-premium flex flex-col justify-between px-l pt-l pb-l">
            <LogoMark />
      ...
      <div className="fixed inset-0 md:hidden flex flex-col" style={{ zIndex: 90 }}>
        ...
        <div
          className="relative mt-auto h-[400px] backdrop-blur-popup bg-profile-sheet-bg bg-surface-premium border-t border-l border-r border-white-20 rounded-tl-popup rounded-tr-popup flex flex-col items-center justify-between pt-[84px] pb-l px-l shadow-popup"
